...
vector<string> bfs(map<string, vector<string>>& adj, const string& target, bool& found) {
...
int main() {
    ...
    vector<string> ans = bfs(adj, target, found);
    ...
    cout << endl;
    cout << "Elapsed time: " << elapsed_seconds.count() << " ns" << endl;
